...
function loadImage(src,load_cnt) {
    var image = new Image();
...
$(window).load(function() {
    ...
    $('#load').click(function() {
        $('#dialog').html('<div class="contents">Pick one of the sample images below or upload an image of your own:<div class="images">' +
            '<img class="loader" src="single_cover.jpg" height="100">' +
            '<img class="loader" src="single_cover.jpg" height="100">' +
            '<img class="loader" src="single_cover.jpg" height="100">' +
            '<img class="loader" src="single_cover.jpg" height="100">' +
            '<img class="loader" src="single_cover.jpg" height="100">' +
    ...
    $('#save').click(function() {
        ...
        window.open(cv.toDataURL('image/png'));
    });
...
var filters = {
    ...
    'Warp': [
        ...
        new Filter('Perspective', function() {
            ...
            this.addNub('a', 0.25, 0.35);
            this.addNub('b', 0.85, 0.35);
            this.addNub('c', 0.25, 0.95);
...
function join_this() {
    ...
    img.src = "input_model.png";

}


function cv_draw(texture){
